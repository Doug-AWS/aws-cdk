...
namespace Aws.Cdk.Lambda
{
    public class LambdaProps : DeputyBase, ILambdaProps
    {
        ...
        /// code as inline text.
        /// </summary>
        [JsiiProperty("code", "{\"fqn\":\"jsii$_aws_cdk_lambda$.LambdaCode\"}", true)]
        ...
        /// Guide.
        /// </summary>
        [JsiiProperty("runtime", "{\"fqn\":\"jsii$_aws_cdk_lambda$.LambdaRuntime\"}", true)]
        ...
        /// </summary>
        [JsiiProperty("initialPolicy", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_core$.PolicyStatement\"}},\"optional\":true}", true)]
