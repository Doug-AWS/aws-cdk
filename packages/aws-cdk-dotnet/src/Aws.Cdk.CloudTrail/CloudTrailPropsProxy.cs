...
{
    [JsiiInterfaceProxy("@aws-cdk/cloudtrail", "jsii$_aws_cdk_cloudtrail$.CloudTrailProps")]
    public class CloudTrailPropsProxy : DeputyBase, ICloudTrailProps
    {
        ...
        /// </summary>
        [JsiiProperty("managementEvents", "{\"primitive\":\"string\",\"optional\":true}")]
        public virtual string ManagementEvents
        {
        ...
        [JsiiProperty("cloudWatchLogsRetentionTimeDays", "{\"primitive\":\"number\",\"optional\":true}")]
        public virtual double? CloudWatchLogsRetentionTimeDays
        {
        ...
        [JsiiProperty("kmsKey", "{\"fqn\":\"jsii$_aws_cdk_kms$.EncryptionKeyRef\",\"optional\":true}")]
