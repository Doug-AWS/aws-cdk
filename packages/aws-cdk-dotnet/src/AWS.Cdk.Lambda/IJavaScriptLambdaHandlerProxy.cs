...
namespace AWS.Cdk.Lambda
{
    ...
    /// </summary>
    [JsiiInterfaceProxy("@aws-cdk/lambda", "jsii$_aws_cdk_lambda$.IJavaScriptLambdaHandler")]
    public class IJavaScriptLambdaHandlerProxy : DeputyBase, IIJavaScriptLambdaHandler
    {
        ...
        {
            InvokeVoidMethod(new object[]{@event, context, callback});
        }
    }
}