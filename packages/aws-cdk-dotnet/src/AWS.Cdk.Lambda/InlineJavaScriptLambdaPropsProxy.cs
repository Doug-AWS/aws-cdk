...
{
    [JsiiInterfaceProxy("@aws-cdk/lambda", "jsii$_aws_cdk_lambda$.InlineJavaScriptLambdaProps")]
    public class InlineJavaScriptLambdaPropsProxy : DeputyBase, IInlineJavaScriptLambdaProps
    {
        ...
        /// </summary>
        [JsiiProperty("handler", "{\"fqn\":\"jsii$_aws_cdk_lambda$.IJavaScriptLambdaHandler\"}")]
        public virtual IIJavaScriptLambdaHandler Handler
        {
            get => GetProperty<IIJavaScriptLambdaHandler>();
        ...
        /// Guide.
        /// </summary>
        /// <remarks>default: NodeJS610</remarks>
        [JsiiProperty("runtime", "{\"primitive\":\"number\",\"optional\":true}")]
