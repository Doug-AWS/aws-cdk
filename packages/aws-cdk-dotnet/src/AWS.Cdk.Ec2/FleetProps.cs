...
namespace AWS.Cdk.Ec2
{
    ...
    public class FleetProps : DeputyBase, IFleetProps
    {
        ...
        [JsiiProperty("machineImage", "{\"fqn\":\"jsii$_aws_cdk_ec2$.IMachineImageSource\"}", true)]
        ...
        [JsiiProperty("notificationsTopic", "{\"fqn\":\"jsii$_aws_cdk_resources$.sns.TopicResource\",\"optional\":true}", true)]
