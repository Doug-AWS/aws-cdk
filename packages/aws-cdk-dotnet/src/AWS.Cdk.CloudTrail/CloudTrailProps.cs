...
namespace AWS.Cdk.CloudTrail
{
    public class CloudTrailProps : DeputyBase, ICloudTrailProps
    {
        ...
        /// </summary>
        [JsiiProperty("managementEvents", "{\"primitive\":\"string\",\"optional\":true}", true)]
        public string ManagementEvents
        {
            get;
            set;
        }
        ...
        [JsiiProperty("cloudWatchLogsRetentionTimeDays", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? CloudWatchLogsRetentionTimeDays
        {
            get;
            set;
        }
        ...
        [JsiiProperty("kmsKey", "{\"fqn\":\"jsii$_aws_cdk_kms$.EncryptionKeyRef\",\"optional\":true}", true)]
