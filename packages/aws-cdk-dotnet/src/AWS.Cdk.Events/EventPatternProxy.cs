...
namespace AWS.Cdk.Events
{
    ...
    [JsiiInterfaceProxy("@aws-cdk/events", "jsii$_aws_cdk_events$.EventPattern")]
    public class EventPatternProxy : DeputyBase, IEventPattern
    {
        ...
        /// resource ARNs.
        /// </summary>
        [JsiiProperty("resources", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_core$.Arn\"}},\"optional\":true}")]
