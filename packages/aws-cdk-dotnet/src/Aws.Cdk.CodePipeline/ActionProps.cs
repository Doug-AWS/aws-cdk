...
namespace Aws.Cdk.CodePipeline
{
    ...
    public class ActionProps : DeputyBase, IActionProps
    {
        ...
        /// </summary>
        [JsiiProperty("category", "{\"fqn\":\"jsii$_aws_cdk_codepipeline$.ActionCategory\"}", true)]
        ...
        [JsiiProperty("artifactBounds", "{\"fqn\":\"jsii$_aws_cdk_codepipeline$.ActionArtifactBounds\"}", true)]
