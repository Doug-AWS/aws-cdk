...
namespace AWS.Cdk.S3
{
    ...
    public class LifecycleRule : DeputyBase, ILifecycleRule
    {
        ...
        /// </summary>
        [JsiiProperty("noncurrentVersionTransitions", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_s3$.NoncurrentVersionTransition\"}},\"optional\":true}", true)]
        ...
        [JsiiProperty("transitions", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_s3$.Transition\"}},\"optional\":true}", true)]
