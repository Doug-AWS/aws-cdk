...
namespace AWS.Cdk.S3
{
    public class BucketProps : DeputyBase, IBucketProps
    {
        ...
        [JsiiProperty("encryption", "{\"primitive\":\"string\",\"optional\":true}", true)]
        ...
        [JsiiProperty("removalPolicy", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? RemovalPolicy
        {
            get;
            set;
        }
        ...
        /// to addToPolicy.
        /// </remarks>
        [JsiiProperty("policy", "{\"fqn\":\"jsii$_aws_cdk_s3$.BucketPolicy\",\"optional\":true}", true)]
        ...
        [JsiiProperty("lifecycleRules", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_s3$.LifecycleRule\"}},\"optional\":true}", true)]
