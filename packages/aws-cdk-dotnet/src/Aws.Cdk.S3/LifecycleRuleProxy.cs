...
namespace Aws.Cdk.S3
{
    ...
    [JsiiInterfaceProxy("@aws-cdk/s3", "jsii$_aws_cdk_s3$.LifecycleRule")]
    public class LifecycleRuleProxy : DeputyBase, ILifecycleRule
    {
        ...
        /// </summary>
        [JsiiProperty("noncurrentVersionTransitions", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_s3$.NoncurrentVersionTransition\"}},\"optional\":true}")]
        public virtual INoncurrentVersionTransition[] NoncurrentVersionTransitions
        {
            get => GetProperty<INoncurrentVersionTransition[]>();
            set => SetProperty(value);
        }
        ...
        [JsiiProperty("transitions", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_s3$.Transition\"}},\"optional\":true}")]
        public virtual ITransition[] Transitions
        {
            get => GetProperty<ITransition[]>();
            set => SetProperty(value);
        }
