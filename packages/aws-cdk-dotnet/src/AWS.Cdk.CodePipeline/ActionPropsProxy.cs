...
namespace AWS.Cdk.CodePipeline
{
    ...
    [JsiiInterfaceProxy("@aws-cdk/codepipeline", "jsii$_aws_cdk_codepipeline$.ActionProps")]
    public class ActionPropsProxy : DeputyBase, IActionProps
    {
        ...
        [JsiiProperty("artifactBounds", "{\"fqn\":\"jsii$_aws_cdk_codepipeline$.ActionArtifactBounds\"}")]
        public virtual IActionArtifactBounds ArtifactBounds
        {
            get => GetProperty<IActionArtifactBounds>();
            set => SetProperty(value);
        }
