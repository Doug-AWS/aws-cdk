...
namespace AWS.Cdk
{
    ...
    /// </summary>
    [JsiiClass("@aws-cdk/core", "jsii$_aws_cdk_core$.Construct", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}}]")]
    public class Construct : DeputyBase
    {
        ...
        [JsiiProperty("parent", "{\"fqn\":\"jsii$_aws_cdk_core$.Construct\",\"optional\":true}")]
        ...
        [JsiiProperty("children", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}}}")]
        ...
        /// </summary>
        [JsiiProperty("metadata", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_core$.MetadataEntry\"}}}")]
        public virtual IMetadataEntry[] Metadata
        {
            get => GetProperty<IMetadataEntry[]>();
        }
        ...
        {
            return InvokeMethod<string>(new object[]{depth});
        }

        /// <summary>Return a descendant by path, or undefined</summary>
        /// <returns>a child by path or undefined if not found.</returns>
        [JsiiMethod("tryFindChild", "{\"fqn\":\"jsii$_aws_cdk_core$.Construct\",\"optional\":true}", "[{\"name\":\"path\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual Construct TryFindChild(string path)
        {
            return InvokeMethod<Construct>(new object[]{path});
        }
        ...
        [JsiiMethod("findChild", "{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}", "[{\"name\":\"path\",\"type\":{\"primitive\":\"string\"}}]")]
        ...
        {
            return InvokeMethod<object>(new object[]{key});
        }
        ...
        [JsiiMethod("addMetadata", "{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}", "[{\"name\":\"type\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"data\",\"type\":{\"primitive\":\"any\"}},{\"name\":\"from\",\"type\":{\"primitive\":\"any\",\"optional\":true}}]")]
        public virtual Construct AddMetadata(string type, object data, object from)
        {
            return InvokeMethod<Construct>(new object[]{type, data, from});
        }

        /// <summary>Adds a { warning: &lt;message&gt; } metadata entry to this construct.</summary>
        /// <param name = "message">The warning message.</param>
        [JsiiMethod("addWarning", "{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}", "[{\"name\":\"message\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual Construct AddWarning(string message)
        {
            return InvokeMethod<Construct>(new object[]{message});
        }
        ...
        [JsiiMethod("validateTree", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_core$.ValidationError\"}}}", "[]")]
        public virtual ValidationError[] ValidateTree()
        {
            return InvokeMethod<ValidationError[]>(new object[]{});
        }

        /// <summary>Return the ancestors (including self) of this Construct up until and excluding the indicated component</summary>
        [JsiiMethod("ancestors", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}}}", "[{\"name\":\"upTo\",\"type\":{\"fqn\":\"jsii$_aws_cdk_core$.Construct\",\"optional\":true}}]")]
        protected virtual Construct[] Ancestors(Construct upTo)
        {
            return InvokeMethod<Construct[]>(new object[]{upTo});
        }
        ...
        {
            return InvokeMethod<object>(new object[]{props, name});
        }
        ...
        [JsiiMethod("addChild", null, "[{\"name\":\"child\",\"type\":{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}},{\"name\":\"childName\",\"type\":{\"primitive\":\"string\"}}]")]
        protected virtual void AddChild(Construct child, string childName)
        {
            InvokeVoidMethod(new object[]{child, childName});
        }
