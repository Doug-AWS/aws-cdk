...
namespace AWS.Cdk
{
    ...
    /// </summary>
    [JsiiInterfaceProxy("@aws-cdk/core", "jsii$_aws_cdk_core$.CreationPolicy")]
    public class CreationPolicyProxy : DeputyBase, ICreationPolicy
    {
        ...
        /// update to succeed.
        /// </summary>
        [JsiiProperty("autoScalingCreationPolicy", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingCreationPolicy\",\"optional\":true}")]
        public virtual IAutoScalingCreationPolicy AutoScalingCreationPolicy
        {
            get => GetProperty<IAutoScalingCreationPolicy>();
        ...
        /// </summary>
        [JsiiProperty("resourceSignal", "{\"fqn\":\"jsii$_aws_cdk_core$.ResourceSignal\",\"optional\":true}")]
        public virtual IResourceSignal ResourceSignal
        {
            get => GetProperty<IResourceSignal>();
            set => SetProperty(value);
        }
    }
}