...
namespace AWS.Cdk
{
    ...
    /// </summary>
    [JsiiInterfaceProxy("@aws-cdk/core", "jsii$_aws_cdk_core$.AutoScalingRollingUpdate")]
    public class AutoScalingRollingUpdateProxy : DeputyBase, IAutoScalingRollingUpdate
    {
