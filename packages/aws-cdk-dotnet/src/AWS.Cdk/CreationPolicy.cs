...
namespace AWS.Cdk
{
    ...
    public class CreationPolicy : DeputyBase, ICreationPolicy
    {
        ...
        /// update to succeed.
        /// </summary>
        [JsiiProperty("autoScalingCreationPolicy", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingCreationPolicy\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("resourceSignal", "{\"fqn\":\"jsii$_aws_cdk_core$.ResourceSignal\",\"optional\":true}", true)]
