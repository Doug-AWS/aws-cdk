...
namespace AWS.Cdk
{
    ...
    /// Auto Scaling group.
    /// </summary>
    [JsiiInterfaceProxy("@aws-cdk/core", "jsii$_aws_cdk_core$.AutoScalingReplacingUpdate")]
    public class AutoScalingReplacingUpdateProxy : DeputyBase, IAutoScalingReplacingUpdate
    {
