...
namespace AWS.Cdk
{
    public class ResourceOptions : DeputyBase, IResourceOptions
    {
        ...
        /// </summary>
        [JsiiProperty("condition", "{\"fqn\":\"jsii$_aws_cdk_core$.Condition\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("creationPolicy", "{\"fqn\":\"jsii$_aws_cdk_core$.CreationPolicy\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("deletionPolicy", "{\"primitive\":\"string\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("updatePolicy", "{\"fqn\":\"jsii$_aws_cdk_core$.UpdatePolicy\",\"optional\":true}", true)]
