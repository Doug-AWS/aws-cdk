...
namespace AWS.Cdk
{
    ...
    /// </summary>
    [JsiiInterfaceProxy("@aws-cdk/core", "jsii$_aws_cdk_core$.UpdatePolicy")]
    public class UpdatePolicyProxy : DeputyBase, IUpdatePolicy
    {
        ...
        /// </summary>
        [JsiiProperty("autoScalingReplacingUpdate", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingReplacingUpdate\",\"optional\":true}")]
        public virtual IAutoScalingReplacingUpdate AutoScalingReplacingUpdate
        {
            get => GetProperty<IAutoScalingReplacingUpdate>();
        ...
        /// </summary>
        [JsiiProperty("autoScalingRollingUpdate", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingRollingUpdate\",\"optional\":true}")]
        public virtual IAutoScalingRollingUpdate AutoScalingRollingUpdate
        {
            get => GetProperty<IAutoScalingRollingUpdate>();
            set => SetProperty(value);
        }
        ...
        /// policy.
        /// </summary>
        [JsiiProperty("autoScalingScheduledAction", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingScheduledAction\",\"optional\":true}")]
        public virtual IAutoScalingScheduledAction AutoScalingScheduledAction
        {
            get => GetProperty<IAutoScalingScheduledAction>();
            set => SetProperty(value);
        }
    }
}