...
namespace AWS.Cdk.Rds
{
    ...
    public class DatabaseClusterProps : DeputyBase, IDatabaseClusterProps
    {
        ...
        [JsiiProperty("engine", "{\"fqn\":\"jsii$_aws_cdk_rds$.DatabaseClusterEngine\"}", true)]
        ...
        [JsiiProperty("instanceProps", "{\"fqn\":\"jsii$_aws_cdk_rds$.InstanceProps\"}", true)]
        ...
        [JsiiProperty("masterUser", "{\"fqn\":\"jsii$_aws_cdk_rds$.Login\"}", true)]
        ...
        [JsiiProperty("backup", "{\"fqn\":\"jsii$_aws_cdk_rds$.BackupProps\",\"optional\":true}", true)]
        ...
        [JsiiProperty("kmsKeyArn", "{\"fqn\":\"jsii$_aws_cdk_resources$.kms.KeyArn\",\"optional\":true}", true)]
