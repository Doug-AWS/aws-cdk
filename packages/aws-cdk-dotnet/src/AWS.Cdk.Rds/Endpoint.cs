...
namespace AWS.Cdk.Rds
{
    ...
    /// </summary>
    [JsiiClass("@aws-cdk/rds", "jsii$_aws_cdk_rds$.Endpoint", "[{\"name\":\"address\",\"type\":{\"fqn\":\"jsii$_aws_cdk_resources$.rds.DBClusterEndpointAddress\"}},{\"name\":\"port\",\"type\":{\"fqn\":\"jsii$_aws_cdk_rds$.Port\"}}]")]
    public class Endpoint : DeputyBase
    {
        ...
        [JsiiProperty("hostname", "{\"fqn\":\"jsii$_aws_cdk_resources$.rds.DBClusterEndpointAddress\"}")]
        ...
        [JsiiProperty("socketAddress", "{\"fqn\":\"jsii$_aws_cdk_rds$.SocketAddress\"}")]
        public virtual SocketAddress SocketAddress
        {
            get => GetProperty<SocketAddress>();
        }
    }
}