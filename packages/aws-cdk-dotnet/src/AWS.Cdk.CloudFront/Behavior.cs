...
namespace AWS.Cdk.CloudFront
{
    ...
    public class Behavior : DeputyBase, IBehavior
    {
        ...
        [JsiiProperty("allowedMethods", "{\"primitive\":\"string\",\"optional\":true}", true)]
        ...
        /// <remarks>default: GET_HEAD</remarks>
        [JsiiProperty("cachedMethods", "{\"primitive\":\"string\",\"optional\":true}", true)]
        ...
        [JsiiProperty("forwardedValues", "{\"fqn\":\"jsii$_aws_cdk_resources$.cloudfront.DistributionResource.ForwardedValuesProperty\",\"optional\":true}", true)]
