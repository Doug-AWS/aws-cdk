...
namespace AWS.Cdk.Sqs
{
    ...
    public class QueueProps : DeputyBase, IQueueProps
    {
        ...
        [JsiiProperty("deadLetterQueue", "{\"fqn\":\"jsii$_aws_cdk_sqs$.DeadLetterQueue\",\"optional\":true}", true)]
        ...
        [JsiiProperty("encryptionMasterKey", "{\"fqn\":\"jsii$_aws_cdk_kms$.EncryptionKeyRef\",\"optional\":true}", true)]
