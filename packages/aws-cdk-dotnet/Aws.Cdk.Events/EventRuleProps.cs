...
namespace Aws.Cdk.Events
{
    public class EventRuleProps : DeputyBase, IEventRuleProps
    {
        ...
        /// pattern.
        /// </remarks>
        [JsiiProperty("eventPattern", "{\"fqn\":\"jsii$_aws_cdk_events$.EventPattern\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("targets", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_events$.IEventRuleTarget\"}},\"optional\":true}", true)]
        public IIEventRuleTarget[] Targets
        {
            get;
            set;
        }
