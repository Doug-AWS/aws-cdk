...
namespace Aws.Cdk.CodeBuild
{
    public class BuildProjectProps : DeputyBase, IBuildProjectProps
    {
        ...
        [JsiiProperty("source", "{\"fqn\":\"jsii$_aws_cdk_codebuild$.BuildSource\"}", true)]
        ...
        /// If not specified, a role will be created.
        /// </summary>
        [JsiiProperty("encryptionKey", "{\"fqn\":\"jsii$_aws_cdk_kms$.EncryptionKeyRef\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("cacheBucket", "{\"fqn\":\"jsii$_aws_cdk_s3$.BucketRef\",\"optional\":true}", true)]
        ...
        [JsiiProperty("environment", "{\"fqn\":\"jsii$_aws_cdk_codebuild$.BuildEnvironment\",\"optional\":true}", true)]
        ...
        [JsiiProperty("artifacts", "{\"fqn\":\"jsii$_aws_cdk_codebuild$.BuildArtifacts\",\"optional\":true}", true)]
        ...
        [JsiiProperty("environmentVariables", "{\"collection\":{\"kind\":\"map\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_codebuild$.BuildEnvironmentVariable\"}},\"optional\":true}", true)]
