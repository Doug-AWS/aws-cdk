...
{
    [JsiiInterfaceProxy("@aws-cdk/codebuild", "jsii$_aws_cdk_codebuild$.S3BucketBuildArtifactsProps")]
    public class S3BucketBuildArtifactsPropsProxy : DeputyBase, IS3BucketBuildArtifactsProps
    {
