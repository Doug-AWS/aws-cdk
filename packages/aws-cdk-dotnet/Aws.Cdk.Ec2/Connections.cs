...
namespace Aws.Cdk.Ec2
{
    ...
    [JsiiClass("@aws-cdk/ec2", "jsii$_aws_cdk_ec2$.Connections", "[{\"name\":\"securityGroup\",\"type\":{\"fqn\":\"jsii$_aws_cdk_ec2$.ISecurityGroup\"}}]")]
    public class Connections : DeputyBase, IIConnections
    {
        ...
        [JsiiMethod("allowToDefaultPort", null, "[{\"name\":\"other\",\"type\":{\"fqn\":\"jsii$_aws_cdk_ec2$.IDefaultConnectable\"}},{\"name\":\"description\",\"type\":{\"primitive\":\"string\"}}]")]
        ...
        [JsiiMethod("allowInternally", null, "[{\"name\":\"portRange\",\"type\":{\"fqn\":\"jsii$_aws_cdk_ec2$.IPortRange\"}},{\"name\":\"description\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual void AllowInternally(IIPortRange portRange, string description)
        {
            InvokeVoidMethod(new object[]{portRange, description});
        }

        /// <summary>Allow to all IPv4 ranges</summary>
        [JsiiMethod("allowToAnyIpv4", null, "[{\"name\":\"portRange\",\"type\":{\"fqn\":\"jsii$_aws_cdk_ec2$.IPortRange\"}},{\"name\":\"description\",\"type\":{\"primitive\":\"string\"}}]")]
        ...
        [JsiiMethod("allowFromAnyIpv4", null, "[{\"name\":\"portRange\",\"type\":{\"fqn\":\"jsii$_aws_cdk_ec2$.IPortRange\"}},{\"name\":\"description\",\"type\":{\"primitive\":\"string\"}}]")]
