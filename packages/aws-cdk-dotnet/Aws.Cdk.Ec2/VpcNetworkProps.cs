...
namespace Aws.Cdk.Ec2
{
    ...
    public class VpcNetworkProps : DeputyBase, IVpcNetworkProps
    {
        ...
        /// </summary>
        [JsiiProperty("defaultInstanceTenancy", "{\"primitive\":\"string\",\"optional\":true}", true)]
        public string DefaultInstanceTenancy
        {
            get;
            set;
        }
        ...
        [JsiiProperty("tags", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"jsii$_aws_cdk_core$.Tag\"}},\"optional\":true}", true)]
        public ITag[] Tags
        {
            get;
            set;
        ...
        /// </summary>
        [JsiiProperty("outboundTraffic", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? OutboundTraffic
        {
            get;
            set;
        }
