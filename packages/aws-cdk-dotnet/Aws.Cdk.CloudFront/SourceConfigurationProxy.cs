...
namespace Aws.Cdk.CloudFront
{
    ...
    /// </summary>
    [JsiiInterfaceProxy("@aws-cdk/cloudfront", "jsii$_aws_cdk_cloudfront$.SourceConfiguration")]
    public class SourceConfigurationProxy : DeputyBase, ISourceConfiguration
    {
        ...
        {
            get => GetProperty<IS3OriginConfig>();
        }
        ...
        {
            get => GetProperty<ICustomOriginConfig>();
        }
