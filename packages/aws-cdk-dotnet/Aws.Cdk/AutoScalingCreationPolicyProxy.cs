...
namespace Aws.Cdk
{
    ...
    /// update to succeed.
    /// </summary>
    [JsiiInterfaceProxy("@aws-cdk/core", "jsii$_aws_cdk_core$.AutoScalingCreationPolicy")]
    public class AutoScalingCreationPolicyProxy : DeputyBase, IAutoScalingCreationPolicy
    {
