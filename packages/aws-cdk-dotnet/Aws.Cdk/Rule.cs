...
namespace Aws.Cdk
{
    ...
    [JsiiClass("@aws-cdk/core", "jsii$_aws_cdk_core$.Rule", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"jsii$_aws_cdk_core$.Construct\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"props\",\"type\":{\"fqn\":\"jsii$_aws_cdk_core$.RuleProps\",\"optional\":true}}]")]
    public class Rule : Referenceable
    {
        ...
        /// </summary>
        [JsiiProperty("ruleCondition", "{\"fqn\":\"jsii$_aws_cdk_core$.FnCondition\",\"optional\":true}")]
        ...
        [JsiiMethod("addAssertion", null, "[{\"name\":\"condition\",\"type\":{\"fqn\":\"jsii$_aws_cdk_core$.FnCondition\"}},{\"name\":\"description\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual void AddAssertion(FnCondition condition, string description)
        {
            InvokeVoidMethod(new object[]{condition, description});
        }
