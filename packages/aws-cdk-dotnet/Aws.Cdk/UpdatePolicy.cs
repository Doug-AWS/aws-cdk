...
namespace Aws.Cdk
{
    ...
    public class UpdatePolicy : DeputyBase, IUpdatePolicy
    {
        ...
        /// </summary>
        [JsiiProperty("autoScalingReplacingUpdate", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingReplacingUpdate\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("autoScalingRollingUpdate", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingRollingUpdate\",\"optional\":true}", true)]
        ...
        /// policy.
        /// </summary>
        [JsiiProperty("autoScalingScheduledAction", "{\"fqn\":\"jsii$_aws_cdk_core$.AutoScalingScheduledAction\",\"optional\":true}", true)]
